...
class Rds():
    ...
    parityCheckMatrix = np.array(
        [512, 256, 128, 64, 32, 16, 8, 4, 2, 1, 732, 366, 183, 647, 927, 787, 853, 886, 443, 513, 988, 494, 247, 679,
         911, 795], dtype=np.uint16)
    ...
    def DecodeBlock(self):
        ...
        # synchronization error.
            ...
            (self.decodedBits[self.syncNdx:self.syncNdx + 26], corrected) = self.ErrorCorrection(syndrome,
                                                                                                 self.decodedBits[
                                                                                                 self.syncNdx:self.syncNdx + 26])
